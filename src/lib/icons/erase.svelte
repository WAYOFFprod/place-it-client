<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<path d="M1 15H3V17H1V15Z" fill="currentColor" />
	<path d="M1 13H3V15H1V13Z" fill="currentColor" />
	<path d="M7 15H9V17H7V15Z" fill="currentColor" />
	<path d="M3 17H5V19H3V17Z" fill="currentColor" />
	<path d="M1 19H11V21H1V19Z" fill="currentColor" />
	...
	<path d="M21 9H23V11H21V9Z" fill="currentColor" />
